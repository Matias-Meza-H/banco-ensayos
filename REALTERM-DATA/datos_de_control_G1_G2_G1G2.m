...
%% Graficas
hold on
plot(t01,dt01(:,2),'g',t01,dt01(:,3),'g')
...
plot(t07,dt07(:,2),'c',t07,dt07(:,3),'c')
...
plot(t11,dt11(:,2),'c',t11,dt11(:,3),'c')  % media estabilidad
hold off
...
plot(t15,dt15(:,2),'c',t15,dt15(:,3),'c')  %estable
hold off
...
%%
hold on
plot(t16,dt16(:,2),'g',t16,dt16(:,3),'g')
...
plot(t19,dt19(:,2),'c',t19,dt19(:,3),'c')  % estable
